<template>
<h1>使用示例</h1>
  <Demo :component="Skeleton1Demo"></Demo>
  <Demo :component="Skeleton2Demo"></Demo>
...
<script lang="ts">
import Skeleton1Demo from '../demoInstance/Skeleton/Skeleton1.demo.vue';
import Skeleton2Demo from '../demoInstance/Skeleton/Skeleton2.demo.vue';
